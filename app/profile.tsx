...
export default function ProfilePage() {
  ...
  const { user, profile, signOut: authSignOut, loading } = useAuth();
  ...
  const handleSignOut = async () => {
      await authSignOut();
      // On renvoie à l'accueil et on empêche le retour arrière
      router.replace('/'); 
  };
       ...
       {user ? (
            <View style={styles.content}>
                ...
                <View style={styles.statsRow}>
                    <View style={styles.statItem}><Text style={styles.statNumber}>0</Text><Text style={styles.statLabel}>Dessins</Text></View>
                    <View style={styles.statItem}><Text style={styles.statNumber}>0</Text><Text style={styles.statLabel}>Likes</Text></View>
                </View>
